 ...
 **/
inline std::string
getOperatorString(Natron::MergingFunctionEnum operation)
{
    switch (operation) {
    case eMergeATop:
...
inline std::string
getOperatorHelpString(Natron::MergingFunctionEnum operation)
{
    switch (operation) {
    case eMergeATop:
...
inline
Natron::PixmapEnum
getOperatorPixmap(Natron::MergingFunctionEnum operation)
{
    switch (operation) {
    case eMergeATop:
